...
public:
	static cv::Mat generateFacade(int width, int height, int thickness, int num_floors, int num_columns, std::vector<int>& selected_win_types, const std::vector<float>& params, const cv::Scalar& bg_color, const cv::Scalar& fg_color);
